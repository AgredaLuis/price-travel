...
const Contact = () => {
  ...
  return (
    <div className=" min-h-screen flex flex-col items-center justify-center md:mx-32 py-14 lg:py-20 mx-5 mt-10">
      <div className=" flex flex-col lg:flex-row justify-between w-full">
        <form className=" w-full lg:w-2/5 space-y-5 bg-[#F2F2F2] p-5 rounded-xl">
          <h3 className="text-4xl font-semibold text-center">Contact Form</h3>
