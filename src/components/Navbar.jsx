  ...
  return (
    <div>
      <div className=" flex flex-row justify-between p-5 md:px-32 px-5 bg-darkBackground text-white">
        <div className=" flex items-center">
          <Link to="/" spy={true} smooth={true} duration={500}>
            <h1 className=" font-semibold text-xl cursor-pointer">PriceTravel</h1>
          </Link>
        </div>
      ...
      <div
        ...
        } lg:hidden flex flex-col absolute bg-darkBackground text-white left-0 font-semibold text-2xl text-center pb-6 gap-8 w-full h-fit transition-transform duration-500`}
      >
        <Link
          to="home"
          spy={true}
